...
async function getAuthenticatedClient(credentialsPath, tokenPath) {
    ...
    // Si no hay token, solicitar autorización interactiva
    return await getNewToken(oAuth2Client, tokenPath);
}

/**
 * Obtiene un nuevo token de acceso mediante el flujo OAuth2 interactivo
 */
function getNewToken(oAuth2Client, tokenPath) {
    return new Promise((resolve, reject) => {
        ...
        console.log('======================================================');
        console.log('Abre la siguiente URL en tu navegador e inicia sesión:\n');
        console.log(authUrl);
        console.log('\n======================================================\n');
        ...
        rl.question('Introduce el código de autorización obtenido en el navegador: ', (code) => {
            rl.close();
